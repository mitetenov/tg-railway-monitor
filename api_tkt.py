...
class TktGeApi:
    ...
    NOTE: This class is imported into api.py where it inherits from the
    abstract TicketApi base class via the factory/registry.  Direct
    usage of this class standalone is also valid for callers that do not
